...
<?php 
  ...
  switch($accion) {
    ...
    case 'Modificar':
        ...
        if($txtImagen){
            //Si no esta vacio recupero ese nombre de lo contrario le coloco por defecto imaden.jpg
            $fecha= new DateTime();
            $nombreArchivo= ($txtImagen!="")?$fecha->getTimestamp()."_".$_FILES["txtImagen"]["name"]:"imagen.jpg";
            $tmpImagen=$_FILES["txtImagen"]["tmp_name"];
            // muevo archivo temporal
            move_uploaded_file($tmpImagen,"../../img/".$nombreArchivo);
...
// listar los libros guarda todo en una variable que usar en forEach la tr de la tabla para rellenarla l,06
        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" required readonly class="form-control" id="txtID" value="<?php echo $txtID ?>" name="txtID"
                        placeholder="ID" />
                </div>

                <div class="form-group">
                    <label for="txtNombre">Nombre</label>
                    <input type="text" required class="form-control" id="txtNombre" value="<?php echo $txtNombre ?>"
                        name="txtNombre" />
                </div>
                ...
                <div class="form-group">
                   ...
                   <br>
                    ...
                    <!-- Apararecer la imagen el ña parte del djuntar archivo    -->
                    <?php if($txtImagen !="") { ?>
                        <img class="img-thumbnail rounded" src="../../img/<?php echo $txtImagen; ?>" width="50" /> 
                    <?php } ?>

                    <input type="file" class="form-control" id="txtImagen" value="<?php echo $txtImagen ?>"
                        name="txtImagen" />
                </div>
